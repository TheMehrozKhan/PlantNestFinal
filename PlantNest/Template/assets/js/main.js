...
/*--
    Category Dropdown
-----------------------------------*/
const categoryDropdown = (selector) => {
    const categoryDropdown = document.querySelector(selector)

    if (categoryDropdown) {
        const catBtn = categoryDropdown.querySelector(".category-btn")
        const catDropDown = categoryDropdown.querySelector(".category-dropdown")
...
categoryDropdown(".header__main-2-category")
...
/*--
    Trending 02
-----------------------------------*/
var swiper = new Swiper(".trending-active-2 .swiper", {
    loop: true,
    slideVisibleClass: "swiper-slide-visible",
    ...
    // Pagination
    pagination: {
        el: ".trending-active-2 .swiper-pagination",
        clickable: true,
    },
    // Navigation arrows
    navigation: {
        nextEl: ".trending-active-2 .swiper-button-next",
        prevEl: ".trending-active-2 .swiper-button-prev",
    },
})
...
/*--
    Discover
-----------------------------------*/
var swiper = new Swiper(".discover-active .swiper", {
    loop: true,
    slideVisibleClass: "swiper-slide-visible",
    ...
    // Pagination
    pagination: {
        el: ".discover-active .swiper-pagination",
        clickable: true,
    },
    // Navigation arrows
    navigation: {
        nextEl: ".discover-active .swiper-button-next",
        prevEl: ".discover-active .swiper-button-prev",
    },
})
...
var swiper = new Swiper(".quick-shop-active .swiper", {
    ...
    // Pagination
    pagination: {
        el: ".quick-shop-active .swiper-pagination",
        clickable: true,
    },
    // Navigation arrows
    navigation: {
